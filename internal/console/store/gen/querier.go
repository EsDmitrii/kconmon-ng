...
type Querier interface {
	...
	RehashUserPassword(ctx context.Context, arg RehashUserPasswordParams) (int64, error)
	...
	UpdateAlertRuleSyncStatusIfUnchanged(ctx context.Context, arg UpdateAlertRuleSyncStatusIfUnchangedParams) (int64, error)
